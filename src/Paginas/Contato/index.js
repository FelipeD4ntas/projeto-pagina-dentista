    ...
    <EstruturaPagina>
      <div className="contato-container">
        <div className="contato-mapa">
          ...
          <ul className="lista-medicos">
            ...
            <li>
              ...
              <p className='doutores'>Dr. Carlos</p>
            ...
            <li>
              ...
              <p className='doutores'>Dra. Suzana</p>
        ...
        <div className="contato-mapa">
          ...
          <p className='endereco'>Av. Ayrton Senna, 3000 - Barra da Tijuca, Rio de Janeiro - RJ. CEP: 22775-904</p>
